				...
				<div class="e_div">
					...
					<div class="e_right">
						...
						<div class="e_paging">
							...
							@click="service_question_public_myboard_search(s_page.page_StartBno-5,s_searchdto.search_time,s_searchdto.search_type,search_content_)"
							...
							@click="service_question_public_myboard_search(s_page.page_EndBno+1,s_searchdto.search_time,s_searchdto.search_type,search_content_)"
...
export default {
  ...
  mounted() {
	this.$axios.get('/service/question-public-myboard-search')
		.then((res)=>{
			...
			for(var i=1; i<this.s_page.page_EndBno-this.s_page.page_StartBno+1; i++){
				if (i==this.s_page.page_NowBno){
					...
					'href="'+"/service/question-public-myboard-search?page_NowBno="+i+
  ...
  methods: {
        ...
        service_question_public_myboard_search(page_NowBno, search_time, search_type, search_content_){
			var url = '/service/question-public-myboard-search?page_NowBno='+page_NowBno+'&search_time='+search_time+'&search_type='+search_type+'&search_content='+search_content_;
			location.href=url;
        },
		// 글 상세 페이지
...
<style lang="scss" scoped>
	@import "@/assets/scss/service/question_public_myboard_search.scss";
</style>
