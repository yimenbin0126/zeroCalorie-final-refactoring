					...
					<div class="e_right">
						...
						<div class="e_header">
							...
							<div class="e_hd_choice">
								...
								<div id="e_choice_guide" @click="service_question_guide">사이트 이용 가이드</div>
							</div>
						</div>
						...
						<div class="e_paging">
							  <div v-show="s_page.page_prev != null && s_page.page_prev == true"
							   @click="service_question_member_search(s_page.page_StartBno-5, s_searchdto.search_time,s_searchdto.search_type,s_searchdto.search_content)"
							  ...
							  @click="service_question_member_search(s_page.page_EndBno+1,s_searchdto.search_time,s_searchdto.search_type,s_searchdto.search_content)"
...
export default {
  ...
  data () {
 	...
 	created() {
  	...
  	methods: {
	getaxios(){
		this.$axios.get('/service/question-member')
		.then((res)=>{
	...
	service_question_guide: function(){
		location.href='/service/question-guide';
	},
	service_question_write: function(){
		location.href='/service/question-write';
	},
	service_question_member_search(page_StartBno,search_time,search_type,search_content_){
		this.$axios.get('/service/question-member',{
			params : {
...
<style lang="scss" scoped>
	@import "@/assets/scss/service/question_member.scss";
</style>
